...
const AppointmentList = ({ compact = false, showHeader = true, limit = null }) => {
    ...
    return (
      <div style={{
        ...
        <div style={{
          width: '3rem',
          height: '3rem',
          border: '3px solid #fb923c', // Naranja
  ...
  if (error) {
    return (
      <div style={{
        backgroundColor: '#fff1f2', // Rosado muy claro
        border: '1px solid #fecdd3', // Borde rosado
        borderRadius: '12px',
        padding: '2rem',
        textAlign: 'center'
      }}>
        <p style={{ color: '#be123c', fontSize: '0.875rem', margin: '0 0 1rem 0' }}>
          {error}
        </p>
        <button
          ...
          onMouseOver={(e) => e.target.style.backgroundColor = '#f43f5e'}
          onMouseOut={(e) => e.target.style.backgroundColor = '#fb7185'}
        >
          Reintentar
        </button>
      </div>
  ...
  return (
    <div style={{
      ...
      boxShadow: '0 1px 3px rgba(251, 146, 60, 0.1)' // Sombra naranja suave
    }}>
      {/* Header */}
      {showHeader && (
        <div style={{
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderRadius: '8px',
                  backgroundColor: 'white',
                  boxShadow: '0 1px 2px rgba(251, 146, 60, 0.05)'
                }}
              >
                <div style={{
                  display: 'flex',
                ...
                {appointment.notes && (
                  <div style={{
                    ...
                    borderRadius: '0.375rem',
                    marginTop: '0.5rem',
                    borderLeft: '3px solid #fb923c' // Borde izquierdo naranja
                  }}>
      ...
      {limit && filteredAppointments.length > limit && (
        <div style={{
          ...
          marginTop: '1.5rem',
          paddingTop: '1.5rem',
          borderTop: '1px solid #fed7aa' // Borde naranja
        }}>
          <button
            style={{
              padding: '0.5rem 1rem',
